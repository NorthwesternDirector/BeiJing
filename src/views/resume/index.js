    ...
    <>
      <div className={cx('out')}>
        <div className={cx('bg')}>
          ...
          <div className={cx('education')}>
            <div className={cx('margin6')}>
              ...
              <div className={cx('color8')}>中国海洋大学</div>
            </div>
            <div>
              <div className={cx('color-gray', 'small-text')}>
        ...
        <div className={cx('content')}>
          <div>
            <div className={cx('h2', 'color-or', 'margin2')}>工作经历</div>
            <div className={cx('margin12')}>
              <div className={cx('company-title', 'h3', 'margin6')}>
                <IconFont type="icon-mi" className={cx('icon')} />
                <span>小米-数据中台</span>
                <div className={cx('date')}>2020.07-至今</div>
              </div>
              <div className={cx('margin12')}>
                <div className={cx('h4', 'project', 'margin2')}>
                  <span>数据工场</span>
                  <span className={cx('date')}>数据开发平台</span>
                </div>
                <div className={cx('inner-line')}>
                  <div className={cx('p')}>
                    ...
                    版本的平稳运行及快速迭代，作业调度、资源管理、数据查询等核心模块在用户之间也留下了良好的口碑。在项目
                  ...
                  <div>
                    <div>
                      ...
                      基于 React 技术栈，熟练运用 React Hooks 进行常规开发
                      <br /> <span className={cx('point')} />对 Antd 常用 UI
                      组件进行二次封装，满足项目定制化需求覆盖表单增删查改等逻辑场景，提升团队交付效率
                      <br />
                      <span className={cx('point')} />
                      使用 Redux、Context 等工具合理化项目状态管理
                      <br />
                      <Tag>React</Tag>
                      <Tag>React Hooks</Tag>
                      <Tag>Antd</Tag>
              ...
              <div className={cx('inner-line')}>
                ...
                <div>
                  ...
                  <span className={cx('point')} />
                  利用事件流及事件监听原理，优化用户在移动端图表操作体验 <br />
                  <span className={cx('point')} />
                  利用原生 table 元素实现诸如行列滚动吸顶、按层级展开收起、列自动定位等功能 <br />
                  <span className={cx('point')} />
                  利用 Intersection Observer API 及 Performance API 优化项目性能监测策略
                  <br />
                  <Tag>React</Tag>
                  <Tag>Echarts</Tag>
                </div>
        ...
        <div className={cx('page')}>1/2</div>
      </div>
      <div className={cx('out')}>
        <div className={cx('content', 'new-page')}>
          <div className={cx('margin24')}>
