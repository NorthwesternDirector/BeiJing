          ...
          <div className={cx('margin30')}>
            ...
            <div className={cx('margin12')}>
              <div className={cx('line', 'margin6')}>
                ...
                <span className={cx('h3')}>小米-数据中台&nbsp;&nbsp;</span>
              ...
              <div className={cx('margin6')}>
                ...
                <div className={cx('inner-line')}>
                  ...
                  <div>
                    ...
                    - 基于 React 技术栈，利用函数组件及 React
                    hooks，实现业务需求的同时对高频出现的业务逻辑交互元素进行封装
                    <br />- 对 Antd UI
                    常用组件进行二次封装，满足项目定制化需求，覆盖表单增删查改中逻辑类似的场景，提升团队交付效率
                    <br />
              ...
              <div className={cx('inner-line')}>
                ...
                <div className={cx('p')}>
                  在公司各部门迫切看数需求的集中提出以及前端人手不足的情况下，通过沟通后合理化需求降低开发成本、组件封装与复用以及加班保质保量完成阶段性任务等手段，与多位(10+)产品同学顺利高效配合，使集团看板内容的丰富度短期内大幅提升（新增20+主题看板），实现了移动端便捷看数的从无到有；目前该项目几乎涵盖了公司产品生命周期全链路（从计划生产到销售反馈）数据的可视化展示，为各部门看数决策、看数考核等提供了极大的便利。同时，近期对该项目的用户体验，项目性能优化也在逐步进行。
                </div>
                <div>
                  <div>
                    <strong>技术要点</strong>
                  </div>
                  - 利用事件流及事件监听原理，优化用户在移动端的图表操作体验
                  <br />
                  - 利用原生 table 元素实现诸如行列的滚动吸顶、按层级展开收起、列自动定位等功能
                  <br />
                  - 利用 Intersection Observer API 及 Performance API 优化项目埋点性能监测策略
                  <br />
                  <Tag>React</Tag>
                  <Tag>Antd</Tag>
                  <Tag>Echarts</Tag>
